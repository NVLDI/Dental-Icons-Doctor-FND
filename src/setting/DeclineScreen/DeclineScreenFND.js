...
const DeclineScreen = ({ navigation }) => {
  ...
  const filteredData = decline.filter((item) =>
        ...
        <View style={styles.topBar}>
          ...
          {isSearchVisible ? (
            <TextInput
              ...
              placeholder="Search Decline..."
              autoFocus
            />
          ) : (
            <Text style={styles.topBarTitle}>Decline</Text>
          )}
                ...
                <TouchableOpacity key={item.id} style={styles.post} onPress={() => openModal(item)}>
                  ...
                  <View style={styles.detailsDateContainer}>
                    <View style={styles.details}>
                      ...
                      <Text style={styles.detailText}><Text style={styles.bold}>Procedure:</Text> {item.procedure_plan.replace(/[{}"]/g, '')}</Text>
                    </View>
